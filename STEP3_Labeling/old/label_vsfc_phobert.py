...
Model:
    mt3103/VSFC-sentiment-classify-phoBERT
...
# Fallback for models that return LABEL_0/LABEL_1/LABEL_2 instead of named labels.
# UIT-VSFC commonly uses: 0 = negative, 1 = neutral, 2 = positive.
LABEL_NORMALIZATION = {
    "LABEL_0": "negative",
    "LABEL_1": "neutral",
    "LABEL_2": "positive",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Auto-label Vietnamese sentiment with VSFC PhoBERT."
    )
