# -*- coding: utf-8 -*-
"""
Auto-label sentiment for anonymized Vietnamese feedback data.

Model:
    thnhan3/phobert-vietnamese-students-feedback
...
Example:
    python STEP3_Labeling/label_phobert_student_vn.py --input STEP2_Anonymize/posts_anonymized.csv --output STEP3_Labeling/output_labeled_posts_phobert_student_vn.csv

    python STEP3_Labeling/label_phobert_student_vn.py --input STEP2_Anonymize/comments_anonymized.csv --output STEP3_Labeling/output_labeled_comments_phobert_student_vn.csv
"""
...
def predict_batch(classifier, texts: list[str]) -> list[dict]:
    ...
    for scores in outputs:
        ...
        # - list[dict] for one example, or
        # - list[list[dict]] for batched multi-label/multi-class outputs
        ...
        best = max(normalized_scores, key=lambda item: item["score"])
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Auto-label Vietnamese sentiment with PhoBERT student feedback model."
    )
