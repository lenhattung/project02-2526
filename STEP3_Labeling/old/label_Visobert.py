...
Example:
    python STEP3_Labeling/label_vs_Visobert.py --input STEP2_Anonymize/posts_anonymized.csv --output STEP3_Labeling/output_labeled_posts_visobert.csv

    python STEP3_Labeling/label_vs_Visobert.py --input STEP2_Anonymize/comments_anonymized.csv --output STEP3_Labeling/output_labeled_comments_visobert.csv
    """
...
# Label rule for 5CD-AI/Vietnamese-Sentiment-visobert:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Auto-label Vietnamese sentiment with ViSoBERT."
    )
