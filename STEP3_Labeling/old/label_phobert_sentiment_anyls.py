...
Example:
    python STEP3_Labeling/label_phobert_sentiment_anyls.py --input STEP2_Anonymize/posts_anonymized.csv --output STEP3_Labeling/output_labeled_posts_phobert_sentiment.csv

    python STEP3_Labeling/label_phobert_sentiment_anyls.py --input STEP2_Anonymize/comments_anonymized.csv --output STEP3_Labeling/output_labeled_comments_phobert_sentiment.csv
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Auto-label Vietnamese sentiment with PhoBERT sentiment analysis."
    )
