...
print(anonymize_person_names("Hùng Minh môn hiểu biết về DNTU:)))???"))

print(anonymize_person_names("Hoàng Nam bào nào mục xương thì thôi"))

print(anonymize_person_names("Các bạn có biết thầy Lê Nhật Tùng không?"))

print(anonymize_person_names("tui không biết cô nguyễn thị liệu"))

print(anonymize_person_names("sinh viên phạm thế an là ai?"))

print(anonymize_person_names("thông báo về vi phạm nguyên tắc cộng đồng"))